...
class DOTARightLane extends Component {

    constructor(props) {
        console.log("DOTARightLane, Constructor");
        super(props);
        this.state = {
          teamList: [],
          playerList: [],
    ...
    componentWillMount() {
        console.log("DOTARightLane, componentWillMount");
        this.getTeams();
    ...
    getTeams() {
        const self = this;
        console.log("DOTARightLane, getTeams");
    ...
    getPlayers() {
        const self = this;
        //console.log("DOTARightLane, getPlayers");
