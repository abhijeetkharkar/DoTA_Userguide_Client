...
class HeroDetails extends Component {
    ...
    getPlayer(id, callback) {
        const playerURL = 'https://dota-userguide-server.herokuapp.com/api/dota?q=player_from_playerID&id='+id;
    ...
    getMatch(id, callback) {
        const matchURL = 'https://dota-userguide-server.herokuapp.com/api/dota?q=match_from_matchID&id='+id;
